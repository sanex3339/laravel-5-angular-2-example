...
export declare class AppViewManager_ extends AppViewManager {
     ...
     * @internal
     */
    _createViewInContainer(viewContainerLocation: ElementRef, index: number, protoView: viewModule.AppProtoView, context: ElementRef, imperativelyCreatedInjector: ResolvedProvider[]): ViewRef;
    /** @internal */
